...
def collect_record_evidence(xml_path: Path, data_path: Path | None = None,) -> RecordEvidence:
    ...
    if data_path is not None:
        companion_json = parse_json_evidence(data_path)
    else:
...
def assess_xml_file(xml_path: Path, data_path: Path | None = None,) -> AssessmentResult:
    record = collect_record_evidence(xml_path , data_path)
